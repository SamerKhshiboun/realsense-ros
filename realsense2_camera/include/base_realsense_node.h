...
namespace realsense2_camera
{
    ...
    protected:
        ...
        rclcpp_action::GoalResponse handle_goal(const rclcpp_action::GoalUUID & uuid, std::shared_ptr<const TriggeredCalibration::Goal> goal);
        rclcpp_action::CancelResponse handle_cancel(const std::shared_ptr<GoalHandleTriggeredCalibration> goal_handle);
        void handle_accepted(const std::shared_ptr<GoalHandleTriggeredCalibration> goal_handle);
        void execute(const std::shared_ptr<GoalHandleTriggeredCalibration> goal_handle);
